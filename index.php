...
<body>
    ...
    <form action="insertionForm.php" method="POST"  enctype="multipart/form-data">
        <div class="form">
            <span>title</span><br>
            ...
            <div class="">
                ...
                <input type="date" id="start" name="date_achat" style="width:200px;" value="2021-04-04" min="2019-02-04" max="2025-2-4"> <br> <br>
                <div>
